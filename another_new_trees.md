...
|   |   |-- CharlesRice-SubmissionModel.py  
...
|   |-- Sayama.pdf  
|   |-- barabasi-albert.py  
|   |-- bifurcation-diagram-hysteresis.py  
|   |-- bifurcation-diagram-numerical.py  
|   |-- bifurcation-diagram-pitchfork-subcritical.py  
|   |-- bifurcation-diagram-pitchfork-supercritical.py  
|   |-- bifurcation-diagram-transcritical.py  
|   |-- bifurcation-diagram.py  
|   |-- ca-graph-based-phasespace-pie.py  
|   |-- ca-graph-based-phasespace.py  
|   |-- ccdfs-loglog.py  
|   |-- chaotic-behavior-butterfly-effect.py  
|   |-- chaotic-behavior.py  
|   |-- cobweb-plot-exercise.py  
|   |-- cobweb-plot-for-mfa.py  
|   |-- cobweb-plot-for-rga.py  
|   |-- cobweb-plot.py  
|   |-- communities.py  
|   |-- degree-correlation.py  
|   |-- degree-distributions-loglog.py  
|   |-- exponent-estimation.py  
|   |-- exponential-growth-time.py  
|   |-- exponential-growth.py  
|   |-- graph-based-phasespace-exercise.py  
|   |-- graph-based-phasespace.py  
|   |-- interactive-template.py  
|   |-- karate-club-visualization.py  
|   |-- keller-segel-abm.py  
|   |-- logisticgrowth-continuous.py  
|   |-- net-LDR.py  
|   |-- net-diffusion-adaptive.py  
|   |-- net-diffusion.py  
|   |-- net-kuramoto-desync.py  
|   |-- net-kuramoto.py  
|   |-- net-majority.py  
|   |-- net-percolation-plot.py  
|   |-- net-percolation.py  
|   |-- net-sync-analysis.py  
|   |-- network-drawing-options.py  
|   |-- network-layouts.py  
|   |-- networkx-test.py  
|   |-- networkx-test2.py  
|   |-- oscillation-correct-phasespace.py  
|   |-- oscillation-correct.py  
|   |-- oscillation-wrong.py  
|   |-- panic-ca.py  
|   |-- period-doubling-bifurcation-cobweb.py  
|   |-- period-doubling-bifurcation.py  
|   |-- phasespace-drawing-3d.py  
|   |-- phasespace-drawing-bad.py  
|   |-- phasespace-drawing-exercise.py  
|   |-- phasespace-drawing-fibonaccci.py  
|   |-- phasespace-drawing-streamplot.py  
|   |-- phasespace-drawing.py  
|   |-- plot-contour.py  
|   |-- plot-imshow.py  
|   |-- plot-surface-3d.py  
|   |-- plot-vector-field.py  
|   |-- predator-prey-abm-evolvable.py  
|   |-- predator-prey-abm-with-plot.py  
|   |-- predator-prey-abm.py  
|   |-- predator-prey-continuous.py  
|   |-- predator-prey.py  
|   |-- pycxsimulator.py  
|   |-- random-graphs.py  
|   |-- random-walk-2D-pSetter.py  
|   |-- random-walk-2D-standalone.py  
|   |-- random-walk-2D.py  
|   |-- read-adjlist-directed.py  
|   |-- read-adjlist.py  
|   |-- segregation.py  
|   |-- shortest-path.py  
|   |-- small-world-exercise.py  
|   |-- small-world-experiment.py  
|   |-- small-world.py  
|   |-- transport-ca-error.py  
|   |-- transport-ca-escaping.py  
|   |-- transport-ca-imshow.py  
|   |-- transport-ca.py  
|   |-- turing-pattern-PDE.py  
|   |-- van-del-pol-Hopf-bifurcation.py  
|   `-- voter-model.py  
|-- silver-octo-sniffle  
|   |-- README.md  
|   |-- Untitled.ipynb  
|   |-- another_new_trees.md  
|   |-- another_tree.md  
|   |-- file_tree_examples.md  
|   `-- new_trees.md  
|-- site  
|   |-- Orig\ site\ images  
|   |   |-- bibendum.png  
...
|   |   |   |-- contour_example.png  
|   |   |   |-- exercise_1-1.png  
|   |   |   |-- exercise_2.1-bar_and_fill_between.png  
|   |   |   |-- exercise_2.2-vmin_vmax_imshow_and_colorbars.png  
|   |   |   |-- exercise_4-1.png  
|   |   |   |-- exercise_4-2.png  
|   |   |   |-- figure_axes_axis_labeled.png  
|   |   |   |-- fill_example.png  
|   |   |   |-- imshow_example.png  
|   |   |   |-- pcolor_example.png  
|   |   |   |-- plot_example.png  
|   |   |   |-- scatter_example.png  
|   |   |   |-- statistical_example.png  
|   |   |   `-- vector_example.png  
|   |   |-- solutions  
|   |   |   |-- 1.1-subplots_and_basic_plotting.py  
|   |   |   |-- 2.1-bar_and_fill_between.py  
...
|   |-- Applied_SNA_py  
|   |   |-- Week\ 1  
|   |   |   |-- 1.1_Networks-Everywhere.pdf  
|   |   |   |-- 1.2_Network-Definition-and-Vocabulary.pdf  
|   |   |   |-- 1.3_Node-and-Edge-Attributes.pdf  
|   |   |   |-- 1.4_Bipartite-Graphs.pdf  
|   |   |   |-- Assignment+1.ipynb  
|   |   |   |-- Loading+Graphs+in+NetworkX.ipynb  
|   |   |   `-- Quiz_week_1.txt  
|   |   |-- Week\ 2  
|   |   |   |-- 2.1_Clustering-Coefficient.pdf  
|   |   |   |-- 2.2_Distance-Measures.pdf  
|   |   |   |-- 2.3_Connected-Components.pdf  
|   |   |   |-- 2.4_Network-Robustness.pdf  
|   |   |   |-- Assignment+2.ipynb  
|   |   |   |-- Quiz.ipynb  
|   |   |   `-- Visualizing+Graphs+with+NetworkX.ipynb  
|   |   |-- Week\ 3  
|   |   |   |-- 3.1_Degree-and-Closeness-Centrality.pdf  
|   |   |   |-- 3.2_Betweenness-Centrality.pdf  
|   |   |   |-- 3.3_Basic-Page-Rank.pdf  
|   |   |   |-- 3.4_Scaled-Page-Rank.pdf  
|   |   |   |-- 3.5_Hubs-and-Authorities.pdf  
|   |   |   `-- Assignment+3.ipynb  
|   |   |-- week4  
|   |   |   |-- 4.1_Preferential-Attachment-Model.pdf  
|   |   |   |-- 4.2_Small-World-Networks.pdf  
|   |   |   |-- 4.3_Link-Prediction.pdf  
|   |   |   |-- Assignment+4\ -\ Copy.ipynb  
|   |   |   |-- Assignment+4.ipynb  
|   |   |   `-- Graph+Features.ipynb  
|   |   |-- Quiz_Rough_Work.ipynb  
|   |   |-- README.md  
|   |   |-- networks-book-ch02--GRAPHS.pdf  
|   |   |-- networks-book-ch18--Power\ Laws\ and\ Rich-Get-Richer.pdf  
|   |   `-- networks-book-ch20.pdf  
|   |-- LinAlgebra-Python  
|   |   |-- 2.10.\ Dot\ product\ (Part\ 2).ipynb  
|   |   |-- 2.4.\ Scalars,\ Vectors,\ and\ Matrices.ipynb  
|   |   |-- 2.5.\ Tensors.ipynb  
|   |   |-- 2.6.\ Adding\ and\ subtracting\ matrices.ipynb  
|   |   |-- 2.7.\ Errors\ when\ adding\ scalars,\ vectors,\ and\ matrices\ in\ Python.ipynb  
|   |   |-- 2.8.\ Tranpose\ of\ a\ matrix.ipynb  
|   |   `-- 2.9.\ Dot\ product.ipynb  
|   |-- NLP-with-Python  
|   |   |-- data  
|   |   |   |-- small_vocab_en  
|   |   |   `-- small_vocab_fr  
...
|   |   |   |-- embedding.png  
|   |   |   `-- rnn.png  
|   |   |-- Advanced\ NLP\ Tasks\ with\ NLTK.ipynb  
|   |   |-- Amazon\ Reviews.ipynb  
|   |   |-- Attention\ Basics.ipynb  
|   |   |-- Automatically\ Summarize\ Trump's\ State\ of\ the\ Union\ Address.ipynb  
|   |   |-- Avito\ Duplicate\ Ads\ Detection.ipynb  
|   |   |-- BOW_TFIDF_Xgboost_update.ipynb  
|   |   |-- Basic\ NLP\ Tasks\ with\ NLTK.ipynb  
|   |   |-- Bayesian_Inference.ipynb  
|   |   |-- Cleaning\ Text.ipynb  
|   |   |-- ColumnTransformer\ Meets\ NLP.ipynb  
|   |   |-- Deciphering\ Code\ with\ Character-Level\ RNN.ipynb  
|   |   |-- Doc2Vec\ Consumer\ Complaint.ipynb  
|   |   |-- Doc2Vec\ Consumer\ Complaint_3.ipynb  
|   |   |-- EDA\ and\ visualization\ for\ Text\ Data.ipynb  
|   |   |-- Flair\ Practice.ipynb  
|   |   |-- Fuzzy\ String\ Matching.ipynb  
|   |   |-- HMM\ Tagger.html  
|   |   |-- HMM\ Tagger.ipynb  
|   |   |-- HMM\ warmup\ (optional).ipynb  
|   |   |-- Hidden\ Markov\ Models\ for\ POS.ipynb  
|   |   |-- Hotel\ Description\ Generation\ LSTM.ipynb  
|   |   |-- LDA.ipynb  
|   |   |-- LDA_news_headlines.ipynb  
|   |   |-- LIME_SHAP_StackOverflow.ipynb  
|   |   |-- Latent\ Semantic\ Analysis_reviews.ipynb  
|   |   |-- Multi-Class\ Text\ Classification\ LSTM\ Consumer\ complaints.ipynb  
|   |   |-- NER\ 500newsgoldstandard.ipynb  
|   |   |-- NER_NLTK_Spacy.ipynb  
|   |   |-- NER_sklearn.ipynb  
|   |   |-- Query\ Wellformedness.ipynb  
|   |   |-- Quora_bow_tfidf_randomforest.ipynb  
|   |   |-- README.md  
|   |   |-- Rank_metrics.ipynb  
|   |   |-- Search\ relevance.ipynb  
|   |   |-- Sentiment\ Analysis\ with\ RNN.ipynb  
|   |   |-- Sklearn_20newsgroups.ipynb  
|   |   |-- Text\ Classification\ Workshop.ipynb  
|   |   |-- Text\ Classification\ model\ selection.ipynb  
|   |   |-- Text\ Processing_Udacity\ Practice.ipynb  
|   |   |-- TextBlob\ Yelp\ Reviews.ipynb  
|   |   |-- Topic\ Modeling.ipynb  
|   |   |-- Web\ scraping\ Hilton\ Hawaiian\ Village\ TripAdvisor\ Reviews.py  
|   |   |-- Word2vec_xgboost.ipynb  
|   |   |-- Working\ with\ Text\ Data\ in\ Pandas.ipynb  
...
|   |   |-- Concrete_NLP_advice_SLIDES_ODSC_1103.pdf  
|   |   |-- NLP_notebook.ipynb  
|   |   |-- README.md  
|   |   |-- clean_data.csv  
|   |   |-- lorenzo-valla.jpg  
...
|   |-- enviro_mod_notes  
|   |   |-- data  
|   |   |   `-- Tarland_Flow_And_Met_Data.csv  
|   |   |-- images  
|   |   |   |-- Bayesian_Workflow.png  
|   |   |   |-- Black_Box_Model.png  
|   |   |   |-- Black_Box_Model2.png  
|   |   |   |-- Gauss_Error.png  
|   |   |   |-- Jupyter_Clusters_Tab.png  
|   |   |   |-- Output_And_Obs_Time_Series.png  
|   |   |   |-- Output_And_Obs_Time_Series_With_Errors.png  
|   |   |   |-- Output_Time_Series.png  
|   |   |   |-- Tarland_Map.png  
|   |   |   `-- Two_Bucket_Model.png  
|   |   |-- notebooks  
|   |   |   |-- 01_Distributions.ipynb  
|   |   |   |-- 02_Calibration_Likelihood.ipynb  
|   |   |   |-- 03_Monte_Carlo.ipynb  
|   |   |   |-- 04_MCMC.ipynb  
|   |   |   |-- 05_A_Hydrological_Model.ipynb  
|   |   |   |-- 06_Beyond_Metropolis.ipynb  
|   |   |   |-- 07_GLUE.ipynb  
|   |   |   |-- 08_Gaussian_Approx.ipynb  
|   |   |   |-- 09_Summary.ipynb  
|   |   |   `-- odes.ipynb  
|   |   |-- LICENSE  
|   |   `-- README.md  
...
|   |   |-- 2\ -\ Autoawait\ in\ IPython.ipynb  
|   |   |-- 3-back-to-terminal.md  
|   |   |-- 5\ -\ Rich\ Output.ipynb  
|   |   |-- 5b\ -\ Custom\ Display\ Logic\ Exercises.ipynb  
|   |   |-- 6\ -\ Cross-Language-Integration.ipynb  
|   |   |-- demo_autoreload.py  
|   |   |-- environment.yml  
|   |   |-- outline.md  
|   |   |-- readme.md  
...
|   |   |   |   |   |-- percent-degrees-conferred-women-usa.csv  
|   |   |   |   |   |-- recent-college-grads-earnings.csv  
|   |   |   |   |   |-- roman-emperor-reigns.csv  
|   |   |   |   |   `-- us-marriages-divorces-1867-2014.csv  
|   |   |   |   |-- Exercises\ -\ Making\ basic\ plots.ipynb  
|   |   |   |   |-- Exercises\ -\ Plotting\ distributions.ipynb  
|   |   |   |   |-- Exercises\ -\ Subplots\ and\ small\ multiples.ipynb  
|   |   |   |   |-- Exercises\ -\ Using\ matplotlib\ in\ the\ Jupyter\ Notebook.ipynb  
|   |   |   |   `-- Exercises\ -\ matplotlib\ styles.ipynb  
|   |   |   |-- Making\ basic\ plots\ -\ Lines,\ bars,\ pies,\ and\ scatterplots.ipynb  
|   |   |   |-- Plotting\ distributions\ -\ Histograms\ and\ box\ plots.ipynb  
|   |   |   |-- Subplots\ and\ small\ multiples.ipynb  
|   |   |   |-- Using\ matplotlib\ in\ the\ Jupyter\ Notebook.ipynb  
|   |   |   |-- indego-bike-station-usage-patterns-july-aug-2015-flip.png  
|   |   |   `-- matplotlib\ styles.ipynb  
|   |   `-- README.md  
|   |-- tableau  
|   |   |-- getting_started_data_sets.zip  
|   |   `-- the_tableau_interface.twbx  
|   `-- Viz\ Practice.ipynb  
|-- web-scraping  
|   |-- code  
|   |   |-- 01-famous-quotes  
...
|   `-- readme.md  
|-- Diagnostic\ 1.pdf  
|-- Latifat's\ Payment\ Probability\ functions.ipynb  
|-- PythonDataScienceHandbook-master.zip  
|-- adjacentElements.ipynb  
|-- cadcad.png  
|-- dc-michelin-challenge-master.zip  
|-- digital_currency_list.csv  
|-- gitignore_template.txt  
|-- grid_search_text_feature_extraction.ipynb  
|-- learning.md  
`-- topics_extraction_with_nmf_lda.ipynb  
  
215 directories, 2504 files  
